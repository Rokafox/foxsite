export const stories = {
    '1': [
      { type: 'text', content: 'ここで解説された囲碁のルールは、私が囲碁はゲームとしてに最も適していると考えるものであり、今日の国際的な囲碁大会で最も一般的に使用されている日本や中国のルールとまったく同じではない。' },
      { type: 'header', level: 3, content: '1 囲まれた石は取れる' },
      { type: 'text', content: '縦横4ヶ所で囲まれた石が取られちゃう。' },
      { type: 'image', src: '/story1/1.png', alt: '画像の説明' },
      { type: 'text', content: '白1ここで打つともぐもぐできるね。' },
      ...
      { type: 'header', level: 3, content: '2 同局禁止' },
      { type: 'text', content: '石を打つと相手をすぐ前の局面と同じ局面になることはできない。' },
      { type: 'image', src: '/story1/5.png', alt: '画像の説明' },
      { type: 'text', content: '白1を打ってから黒にとってすぐに取り返せないアタリの形です。これはコウのルールという。' },
      { type: 'image', src: '/story1/6.png', alt: '画像の説明' },
      { type: 'text', content: '同局を避けるため黒が一度他の場所に打てなければなりません。白3のあとで黒4で石を取れる、今度は問題ないね。' },
      { type: 'image', src: '/story1/7.png', alt: '画像の説明' },
      { type: 'header', level: 3, content: '3 循環とは無勝負' },
      { type: 'text', content: '黒と白が譲らない同じ戦いを繰り返す、永遠に終わらない局面になると無勝負になる。' },
      { type: 'image', src: '/story1/8.png', alt: '画像の説明' },
      { type: 'text', content: '123で終わらぬ永遠になります。終盤ではここで黒が石2個、白が石8個とカウントされるのは合理的だと思う。' },
      { type: 'image', src: '/story1/9.png', alt: '画像の説明' },
      { type: 'text', content: '負けを避けるために無勝負を利用するかどうかは、個人判断に任せてもいいだろう。しかし、囲碁が競技スポーツである以上、無勝負や引き分けの状況を排除するルールが作らないとは考えられない。' },
      { type: 'header', level: 3, content: '4 石が多いほうが勝ち' },
      { type: 'text', content: '対局は進むといずれ終盤になる。すると盤上に残っている石の数が多い方が勝ちとなる。同じ場合は引き分けとなる。下の図の場合では、中国ルールで数えると7石で黒が勝ち、日本ルールで数えると6目差で同じく黒が勝つ。でも私はやはり生きてる石を数える中国古典のルールを好むね。' },
      ...
      { type: 'text', content: '実は勝敗を決まるために自分の陣地でぎりぎりまで石を埋める必要はなく、この局面でも数えるね。自分の陣地プラス石マイナス2個埋めたらまずい石で計算すれば結果は同じになります。' },
