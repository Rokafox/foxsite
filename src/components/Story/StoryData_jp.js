    ...
    '2': [
      ...
      { type: 'image', src: '/story2/2_1.png', alt: '画像の説明' },
      {
        type: 'text', content: `石を数えると、黒37個、白38個、1個の差で白の勝ち。
                                左上の隅の曲がり4目の形は通常、黒の死に石とされます。なぜなら白がすべてのコウ材を清算した後にコウを仕掛けると、黒に対処の手がありません。
                                しかし、ここでは両者が右下でセキを形成しているため、白は最後のコウ材を清算することができません。白がコウを仕掛けると不利になり、結局、隅の曲がり4目を動かさずに終局になる。
                                ` },
      { type: 'header', level: 3, content: '終局局面2' },
      { type: 'image', src: '/story2/2_2.png', alt: '画像の説明' },
      {
        type: 'text', content: `三劫循環、白1でコウを取った後に終局、数子の結果は黒20個、白21個、1個の差で白の勝ち。黒はコウを取り返すことができますが、それは右側を犠牲にして上側の白を得ることになるで、結果は変わりません。
                                両方が合意すれば、無勝負とも判断できる。
                                ` },
